Package.describe({
  ...
  summary: "Basic serocash for Dapps",
  version: "1.2.0",
  git: "http://github.com/tomdurrent/meteor-package-elements"
});
...
Package.onUse(function(api) {
  ...
  api.use("serocash:web3@0.0.1", "client");
  api.use("serocash:tools@1.0.0", "client");
